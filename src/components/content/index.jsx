...
function Navbar({ className, children, ...rest }) {
  return (
    <nav className={clsx('navbar', className)} {...rest}>
      {children}
    </nav>
  );
}
...
export { Main, Div, Button, Container, ContainerFluid, Sidebar, Article, Modal, Drawer, Navbar, Header, Footer, Figure, Section, Image, Wrapper, Grid, Row, Col };
